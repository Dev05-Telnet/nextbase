...
(function (root, window, document, factory, undefined) {
   ...
   */
  function toggleClass(el, className, fn) {
    if (el.classList && null == fn) el.classList.toggle(className);
    else {
      var o = hasClass(el, className);
      (o && null == fn) || !fn
        ? removeClass(el, className)
        : ((!o && null == fn) || fn) && addClass(el, className);
    }
  }
  /**
  ...
  function prevAll(item, selector) {
    return untilAll(item, selector, "previousElemeninsertBeforetSibling");
  }
